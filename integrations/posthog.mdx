...
<Steps>
  ...
  <Step title="Fill in the form">
    ...
    <Frame>
      <img className="block dark:hidden" src="/img/traceloop-integrations/posthog-light.png" />
      <img className="hidden dark:block" src="/img/traceloop-integrations/posthog-dark.png" />
    </Frame>
    </Step>
</Steps>
...
<Frame>
  <img src="/img/traceloop-integrations/posthog-result.png" />
</Frame>
