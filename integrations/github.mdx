...
<Steps>
  <Step title="Install the Traceloop GitHub App">
    ...
    <Frame>
      <img className="block dark:hidden" src="/img/traceloop-integrations/github-app-install-light.png" />
      <img className="hidden dark:block" src="/img/traceloop-integrations/github-app-install-dark.png" />
    </Frame>
  </Step>
  ...
  <Step title="Create Your Experiment Script">
    Create an experiment script that will run your AI flow with your dataset and evaluators. This script validates your changes by running your agent flow against real test cases and measuring quality with automated evaluators.
    ...
    ```typescript experiments/run-ci-experiments.ts
  ...
  <Step title="View Results in Pull Requests">
    Once configured, every pull request will automatically trigger the experiment run. The Traceloop GitHub App will post a comment with:
    - Overall experiment status (pass/fail)
    - Evaluation metrics and scores
    - Links to detailed results in the Traceloop dashboard
    - Comparison with baseline results when available

    <Frame>
      <img src="/img/traceloop-integrations/github-pr-comment.png" />
    </Frame>
  </Step>
</Steps>
