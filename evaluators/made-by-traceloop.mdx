...
<CardGroup cols={3}>
  ...
  <Card title="Tone Detection" icon="face-smile">
...
<CardGroup cols={3}>
  ...
  <Card title="Prompt Perplexity" icon="hashtag">
...
<CardGroup cols={3}>
  ...
  <Card title="HTML Comparison" icon="code">
...
<CardGroup cols={3}>
  ...
  <Card title="Agent Tool Trajectory" icon="route">
