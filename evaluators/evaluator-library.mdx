...
**Agent Tool Trajectory** <sup>(beta)</sup>
- Compares actual tool calls made by the agent against expected reference tool calls
- Returns similarity score (0-1) with configurable threshold, order sensitivity, and mismatch sensitivity
- *Implementation: Deterministic comparison algorithm*
...
**HTML Comparison**
- Compares two HTML documents for structural and content similarity
- Returns 0-1 similarity score
- *Implementation: HTML parsing and comparison*
...
**Prompt Perplexity**
- Measures prompt perplexity to detect potential injection attempts or unusually crafted prompts
- Returns perplexity score
- *Implementation: Language model perplexity calculation*
