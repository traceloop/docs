...
You can programmatically create custom LLM-as-a-judge evaluators using the API. 

```
POST /v2/evaluators/custom-evaluator
```

See the full [API reference](/api-reference/evaluators/create-custom-evaluator) for detailed parameter documentation.
