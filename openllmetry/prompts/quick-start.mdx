...
<Note>
  ...
  `TRACELOOP_API_KEY` before you start. Check out the [getting started
...
For more information see the [Registry Documentation](/openllmetry/prompts/registry).
...
For more information see the [SDK Usage Documentation](/openllmetry/prompts/sdk-usage).
