...
Traceloop.initialize({ 
  ...
  traceloopSyncPollingInterval: 60, // also via TRACELOOP_SYNC_POLLING_INTERVAL env variable (default: 60) - seconds
  traceloopSyncDevPollingInterval: 5 // also via TRACELOOP_SYNC_DEV_POLLING_INTERVAL env variable (default: 5) - seconds
 });
```
